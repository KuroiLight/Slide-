...
namespace WindowShift
{
    ...
    public static class ApiWrapper
    {
        ...
        public delegate IntPtr HookProc(int code, WM wParam, MSLLHOOKSTRUCT lParam);
        ...
        public static List<IntPtr> GetAvailableWindows()
        {
            ...
            bool OnWindowEnum(IntPtr hwnd, uint lparam)
            {
                ...
                GetWindowModuleFileName(hwnd, filename, 511);
                if (filename.ToString().EndsWith("SHELL32.dll", true, null))
                    return true;
        ...
        public static IntPtr SetMouseHook(HookProc hP)
        {
            return SetWindowsHookEx(WH_MOUSE_LL, hP, IntPtr.Zero, 0);
        }

        public static bool UnhookMouseHook(IntPtr hP)
        {
